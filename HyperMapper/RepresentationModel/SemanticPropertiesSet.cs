...
namespace HyperMapper.RepresentationModel
{
    public class SemanticPropertiesSet : IEnumerable<SemanticProperty>
    {
        ...
        public void AddValue<TTerm>(OneOf<SemanticPropertiesSet, JToken, Term, SemanticPropertiesList> value)
        {
            var semanticProperty = new SemanticProperty(TermFactory.From<TTerm>(), value);
